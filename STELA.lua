...
sudo_users = {SUDO,1313703081 ,1124341247 }   
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ستيلا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ستيلا')
local LAND_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ستيلا').." غادر" or text == 'غادر' then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ستيلا')
